  ...
  <div class="views b_s mr_color01 h_bottom">
    <div class="bg_fff">
      ...
      <div class="views_100ch_1">
        <!--顶部数据-->
        <div class="pad_l_30 pad_r_30 w_100 header_item h_60px b_s font14">系统通知列表（{{total}}）</div>
        <!--输入框、下拉筛选-->
        <div class="flex row w_100 header_item h_60px b_s pad_r_30 pad_l_30">
          ...
          <div class="w_25 flex row w_25 b_s h_100 mar_l_30">
            ...
            <li v-for="(item,index) in list" :key="index">
              <ol :class="index%2==1?'list_bg':''">
                ...
                <li class="f_l pad_l_20 b_s" style="width:13%">
                  <span class="edit_button w_333 f_l" @click="view(item.msgid)">查看</span>
                </li>
                <div class="clearfix"></div>
              </ol>
            </li>
